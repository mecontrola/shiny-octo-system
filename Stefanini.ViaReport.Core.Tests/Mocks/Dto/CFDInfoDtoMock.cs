...
namespace Stefanini.ViaReport.Core.Tests.Mocks.Dto
{
    ...
    {
        public static IDictionary<EasyBIReportColumnName, IList<CFDInfoDto>> CreateCFDData()
        ...
        private static IList<CFDInfoDto> CreateToDoData()
            => new List<CFDInfoDto>
            {
                ...
                new CFDInfoDto { Date = new DateTime(2022, 01, 31), Value = 12 },
                new CFDInfoDto { Date = new DateTime(2022, 02, 07), Value = 12 },
            };
        ...
        private static IList<CFDInfoDto> CreateInProgressData()
            => new List<CFDInfoDto>
            {
                ...
                new CFDInfoDto { Date = new DateTime(2022, 02, 07), Value = 8 },
            };
        ...
        private static IList<CFDInfoDto> CreateDoneData()
            => new List<CFDInfoDto>
            {
                ...
                new CFDInfoDto { Date = new DateTime(2022, 02, 07), Value = 64 },
            };
